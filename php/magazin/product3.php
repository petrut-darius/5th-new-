...
<main>
    <div class='main_product1'>
        <div class='main_div_prod1'>
            <h2>Ceva Graffiti</h2>
            <img src="images/product3.jpg" alt="qqqwertyuiop">
        </div>
    ...
    <div class='aside_product1'>
        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method='post'>
            ...
            <button class='1916' onclick="changeColor()" type='button'>Adauga la favorite</button>
        </form>
    </div>
</main>
<script>
function changeColor() {
  var button = document.getElementsByClassName('1916');
  button.classList.toggle('favActive');
}
</script>
</body>